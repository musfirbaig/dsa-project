...
class InvertedIndex:
    def __init__(self, barrelNo):
        self.barrelNo = barrelNo
        if barrelNo > 2500:
            self.barrelNo = 2500
        self.memoryManage = (3500/barrelNo)*1000
    ...
    def generateInvertedIndex(self, noFiles):
        ...
        hashingObject = Hashing(self.barrelNo)
        startTime = time.time()
        invertedIndex = {}
            ...
            for articleData in forwardIndex:
                ...
                for word in words:
                    ...
                    if barrelName in invertedIndex:
                        ...
                        invertedIndex[barrelName] = {word: [wordObjectInfo]}
                    if sys.getsizeof(invertedIndex[barrelName]) > self.memoryManage:
